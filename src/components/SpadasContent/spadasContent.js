...
import MyMap from './SpadasMap/SpadasMap'


export default class SpadasContent extends Component {
            ...
            <Row>
                <Col flex="400px">
                    <ControlPanel style={{
                        ...
                        overflowY: 'scroll',
                        marginLeft: '2px',
                    }} onClickedDsChange={this.handleClickedDsChange} setConfig={this.props.setConfig}/>
                </Col>
                <Col flex="auto">
